...
const Sidebar: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {/* Sidebar Content */}
      <div
        className={`h-full overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 shadow-2xl transition-all duration-300 ${
      ...
      >
        <div className="flex h-full flex-col">
          ...
          {/* Footer Section */}
          <div className="border-t border-teal-800/50 p-3 bg-slate-900/30">
